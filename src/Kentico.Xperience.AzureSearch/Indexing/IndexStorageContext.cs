...
{
    private readonly IAzureSearchIndexStorageStrategy storageStrategy;
    private readonly string indexStoragePathRoot;
    private readonly IndexRetentionPolicy retentionPolicy;

    public IndexStorageContext(IAzureSearchIndexStorageStrategy selectedStorageStrategy, string indexStoragePathRoot, IndexRetentionPolicy retentionPolicy)
    {
