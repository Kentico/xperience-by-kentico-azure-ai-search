...
internal class UniqueProductSkuValidationRule : ValidationRule<string>
{
    ...
    {
        var contentItemFormContext = FormContext as IContentItemFormContextBase ?? throw new InvalidOperationException("The validation rule can only be used in a content item form context.");
